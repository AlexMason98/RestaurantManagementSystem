...
$sql = "SELECT menu.ImagePath, menu.Price, DietaryRequirements.Item FROM DietaryRequirements CROSS JOIN menu WHERE ContainsMustard = 'Yes' AND menu.ID = DietaryRequirements.ID ";
$res = $conn->query($sql);
if($res-> num_rows == 0){
	echo "0 results";
}
